							...
							<tbody>
								...
								if(mysqli_num_rows($result)>0){
								 ...
								 <tr>
								 	...
								 	<td> <a href="sarana/konfir.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-primary" name="submit">Konfirmasi</button></a> &nbsp; <a href="sarana/non.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-danger">Nonaktifkan</button></a> &nbsp; <a href="sarana/hapus.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-warning">Hapus</button></a> </td>
								 </tr>
