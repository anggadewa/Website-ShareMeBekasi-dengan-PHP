					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li><a href="laporan.php">Lihat Laporan SarPras</a></li>
								<li><a href="laporan1.php">Lihat Laporan Instansi</a></li>
					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								<h2>Halaman Lihat Laporan</h2>
								<p>Lakukan Verifikasi dan Konfirmasi!</p>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-hover table-striped table-bordered" id="datatables">
							...
							<tbody>
								...
								if(mysqli_num_rows($result)>0){
								 ...
								 <tr>
								 	<td> <?php echo $no++ ?> </td>
								 	<td> <?php echo $lap['id_saran'] ?></td>
								 	<td> <?php echo $lap['nama']; ?> </td>
								 	<td> <?php echo $lap['telfon']; ?> </td>
								 	<td> <?php echo $lap['saran']; ?> </td>
								 	<td> <?php echo $lap['target']; ?> </td>
								 	<td> <?php echo $lap['date']; ?> </td>
								 	<td> <?php echo $lap['status']; ?> </td>
								 	<td> <a href="instansi/konfir.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-primary" name="submit">Konfirmasi</button></a> &nbsp; <a href="instansi/non.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-danger">Nonaktifkan</button></a> &nbsp; <a href="instansi/hapus.php?id_saran=<?php echo $lap['id_saran']; ?>"> <button class="btn btn-warning">Hapus</button></a> </td>
								 </tr>
