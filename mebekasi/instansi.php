          ...
          <div class="container">
            <div class="col-md-12 col-md-offset-0">
              <div class="animate-box">
                <h2>Halaman Laporan Untuk Pelayanan Instansi Pemerintahan</h2>
      ...
      <div class="container">
        <form action="instansi.php" method="post">
          ...
          while($saran = mysqli_fetch_array($result)){
              $querysaran = "INSERT INTO instansi (username, nama, telfon, saran, target, status) VALUES ('$username', '$saran[nama]', '$_POST[telfon]', '$_POST[saran]', '$_POST[target]',
               '$_POST[status]')";
