					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								...
								<p><a href="login.php" class="btn btn-primary btn-lg btn-custom">Kunjungi Website</a></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 text-center animate-box">
						<div class="services">
							...
							<div class="desc">
								<h3>Informasi</h3>
								<p>Lihat seluruh informasi mengenai tanggapan dan perkembangan terkini</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						...
						<p>Saran dong gue bingung masukin apaan</p>
					</div>
				</div>
			</div>
		</div>
